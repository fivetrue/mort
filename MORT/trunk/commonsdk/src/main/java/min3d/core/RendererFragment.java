 ...
 */
abstract public class RendererFragment extends Fragment implements ISceneController
{
	public Scene scene;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        glSurfaceViewConfig(_glSurfaceView);
        _glSurfaceView.setRenderer(mRenderer);
     ...
     */
    protected void glSurfaceViewConfig(GLSurfaceView glSurfaceView)
    {
